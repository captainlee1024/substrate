...
/// 不透明类型。CLI 使用这些来实例化不需要知道运行时细节的机器。然后，它们可以对特定格式的数据（如外联函数）不可知，允许它们通过升级甚至核心数据结构来继续同步网络
pub mod opaque {
	use super::*;
	...
	/// Opaque block type.
	/// Block的Header 和 UncheckedExtrinsic在这里确定
...
trait InternalConstructRuntime {
	#[inline(always)]	fn runtime_metadata (& self) -> self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_std :: vec :: Vec < self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: RuntimeApiMetadataIR >{
		Default::default()
	}
}
#[doc(hidden)]
		...
		fn decode<__CodecInputEdqy: ::codec::Input>(
			...
			match __codec_input_edqy.read_byte().map_err(|e| {
				...
				__codec_x_edqy if __codec_x_edqy == 7u8 as ::core::primitive::u8 =>
					::core::result::Result::Ok(RuntimeEvent::TemplateModule({
						let __codec_res_edqy =
				...
				.variant(
					::scale_info::build::Variants::new()
						...
						.variant("TransactionPayment", |v| {
							v.index(5u8 as ::core::primitive::u8).fields(
								::scale_info::build::Fields::unnamed().field(|f| {
						...
						.variant("Sudo", |v| {
							v.index(6u8 as ::core::primitive::u8).fields(
								::scale_info::build::Fields::unnamed().field(|f| {
						...
						.variant("TemplateModule", |v| {
							v.index(7u8 as ::core::primitive::u8).fields(
								::scale_info::build::Fields::unnamed().field(|f| {
...
impl core::fmt::Debug for RuntimeEvent {
	fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
		match self {
			Self::System(ref a0) => fmt.debug_tuple("RuntimeEvent::System").field(a0).finish(),
			Self::Grandpa(ref a0) => fmt.debug_tuple("RuntimeEvent::Grandpa").field(a0).finish(),
			Self::Balances(ref a0) => fmt.debug_tuple("RuntimeEvent::Balances").field(a0).finish(),
			Self::TransactionPayment(ref a0) =>
				fmt.debug_tuple("RuntimeEvent::TransactionPayment").field(a0).finish(),
			Self::Sudo(ref a0) => fmt.debug_tuple("RuntimeEvent::Sudo").field(a0).finish(),
...
const _: () = {
	impl ::scale_info::TypeInfo for OriginCaller {
		type Identity = Self;
		fn type_info() -> ::scale_info::Type {
			:: scale_info :: Type :: builder () . path (:: scale_info :: Path :: new ("OriginCaller" , "node_template_runtime")) . type_params (:: alloc :: vec :: Vec :: new ()) . variant (:: scale_info :: build :: Variants :: new () . variant ("system" , | v | v . index (0u8 as :: core :: primitive :: u8) . fields (:: scale_info :: build :: Fields :: unnamed () . field (| f | f . ty :: < frame_system :: Origin < Runtime > > () . type_name ("frame_system::Origin<Runtime>")))) . variant ("Void" , | v | v . index (1usize as :: core :: primitive :: u8) . fields (:: scale_info :: build :: Fields :: unnamed () . field (| f | f . ty :: < self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: Void > () . type_name ("self::sp_api_hidden_includes_construct_runtime::hidden_include::Void")))))
		}
	};
};
const _: () = {
...
impl
	self::sp_api_hidden_includes_construct_runtime::hidden_include::traits::CallerTrait<
...
pub type AllPalletsWithSystem =
	(System, Timestamp, Aura, Grandpa, Balances, TransactionPayment, Sudo, TemplateModule);
#[cfg(all())]
/// All pallets included in the runtime as a nested tuple of types.
...
pub type AllPalletsWithSystemReversed =
	(TemplateModule, Sudo, TransactionPayment, Balances, Grandpa, Aura, Timestamp, System);
#[cfg(all())]
/// All pallets included in the runtime as a nested tuple of types in reversed order.
/// Excludes the System pallet.
#[deprecated(note = "Using reverse pallet orders is deprecated. use only \
...
pub type AllPalletsWithoutSystemReversed =
	(TemplateModule, Sudo, TransactionPayment, Balances, Grandpa, Aura, Timestamp);
#[cfg(all())]
/// All pallets included in the runtime as a nested tuple of types in reversed order.
...
pub type AllPalletsReversedWithSystemFirst =
	(System, TemplateModule, Sudo, TransactionPayment, Balances, Grandpa, Aura, Timestamp);
	...
	) -> Option<self::sp_api_hidden_includes_construct_runtime::hidden_include::traits::CrateVersion>
	{
		...
		if type_id ==
			self::sp_api_hidden_includes_construct_runtime::hidden_include::sp_std::any::TypeId::of::<
				Grandpa,
			>() {
			return Some (< pallet_grandpa :: Pallet < Runtime > as self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: traits :: PalletInfoAccess > :: crate_version ())
		}
		if type_id ==
			self::sp_api_hidden_includes_construct_runtime::hidden_include::sp_std::any::TypeId::of::<
				Balances,
		...
		if type_id ==
			self::sp_api_hidden_includes_construct_runtime::hidden_include::sp_std::any::TypeId::of::<
				TemplateModule,
			>() {
			return Some (< pallet_template :: Pallet < Runtime > as self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: traits :: PalletInfoAccess > :: crate_version ())
		}
		None
	}
}
...
impl ::core::clone::Clone for RuntimeCall {
	...
	fn clone(&self) -> RuntimeCall {
		match self {
			...
			RuntimeCall::Sudo(__self_0) => RuntimeCall::Sudo(::core::clone::Clone::clone(__self_0)),
		...
		__self_tag == __arg1_tag &&
			match (self, other) {
				...
				(RuntimeCall::Sudo(__self_0), RuntimeCall::Sudo(__arg1_0)) =>
					*__self_0 == *__arg1_0,
				(RuntimeCall::TemplateModule(__self_0), RuntimeCall::TemplateModule(__arg1_0)) =>
					*__self_0 == *__arg1_0,
				_ => unsafe { ::core::intrinsics::unreachable() },
			}
	}
	...
	impl ::codec::Decode for RuntimeCall {
		fn decode<__CodecInputEdqy: ::codec::Input>(
			...
			match __codec_input_edqy.read_byte().map_err(|e| {
				...
				__codec_x_edqy if __codec_x_edqy == 7u8 as ::core::primitive::u8 =>
					::core::result::Result::Ok(RuntimeCall::TemplateModule({
...
impl core::fmt::Debug for RuntimeCall {
	fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
		match self {
			Self::System(ref a0) => fmt.debug_tuple("RuntimeCall::System").field(a0).finish(),
			Self::Timestamp(ref a0) => fmt.debug_tuple("RuntimeCall::Timestamp").field(a0).finish(),
			Self::Grandpa(ref a0) => fmt.debug_tuple("RuntimeCall::Grandpa").field(a0).finish(),
			Self::Balances(ref a0) => fmt.debug_tuple("RuntimeCall::Balances").field(a0).finish(),
	...
	for RuntimeCall
{
	...
	fn get_call_names(module: &str) -> &'static [&'static str] {
		...
		match module {
			"System" =>
				<<System as Callable<Runtime>>::RuntimeCall as GetCallName>::get_call_names(),
			"Timestamp" =>
				<<Timestamp as Callable<Runtime>>::RuntimeCall as GetCallName>::get_call_names(),
			"Grandpa" =>
				<<Grandpa as Callable<Runtime>>::RuntimeCall as GetCallName>::get_call_names(),
			"Balances" =>
				<<Balances as Callable<Runtime>>::RuntimeCall as GetCallName>::get_call_names(),
			"Sudo" => <<Sudo as Callable<Runtime>>::RuntimeCall as GetCallName>::get_call_names(),
			"TemplateModule" =>
				<<TemplateModule as Callable<Runtime>>::RuntimeCall as GetCallName>::get_call_names(
				),
	...
	for RuntimeCall
{
	...
	type Info =
		self::sp_api_hidden_includes_construct_runtime::hidden_include::dispatch::DispatchInfo;
	type PostInfo =
		self::sp_api_hidden_includes_construct_runtime::hidden_include::dispatch::PostDispatchInfo;	fn dispatch (self , origin : RuntimeOrigin) -> self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: dispatch :: DispatchResultWithPostInfo{
		if ! < Self :: RuntimeOrigin as self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: traits :: OriginTrait > :: filter_call (& origin , & self) { return self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_std :: result :: Result :: Err (frame_system :: Error :: < Runtime > :: CallFiltered . into ()) ; }
...
impl Runtime {
	fn metadata_ir(
		...
		let rt = Runtime;
		self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: MetadataIR { pallets : < [_] > :: into_vec (# [rustc_box] :: alloc :: boxed :: Box :: new ([self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletMetadataIR { name : "System" , index : 0u8 , storage : Some (frame_system :: Pallet :: < Runtime > :: storage_metadata ()) , calls : Some (frame_system :: Pallet :: < Runtime > :: call_functions ()) , event : Some (self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletEventMetadataIR { ty : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: scale_info :: meta_type :: < frame_system :: Event < Runtime > > () , }) , constants : frame_system :: Pallet :: < Runtime > :: pallet_constants_metadata () , error : frame_system :: Pallet :: < Runtime > :: error_metadata () , docs : frame_system :: Pallet :: < Runtime > :: pallet_documentation_metadata () , } , self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletMetadataIR { name : "Timestamp" , index : 1u8 , storage : Some (pallet_timestamp :: Pallet :: < Runtime > :: storage_metadata ()) , calls : Some (pallet_timestamp :: Pallet :: < Runtime > :: call_functions ()) , event : None , constants : pallet_timestamp :: Pallet :: < Runtime > :: pallet_constants_metadata () , error : pallet_timestamp :: Pallet :: < Runtime > :: error_metadata () , docs : pallet_timestamp :: Pallet :: < Runtime > :: pallet_documentation_metadata () , } , self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletMetadataIR { name : "Aura" , index : 2u8 , storage : Some (pallet_aura :: Pallet :: < Runtime > :: storage_metadata ()) , calls : None , event : None , constants : pallet_aura :: Pallet :: < Runtime > :: pallet_constants_metadata () , error : pallet_aura :: Pallet :: < Runtime > :: error_metadata () , docs : pallet_aura :: Pallet :: < Runtime > :: pallet_documentation_metadata () , } , self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletMetadataIR { name : "Grandpa" , index : 3u8 , storage : Some (pallet_grandpa :: Pallet :: < Runtime > :: storage_metadata ()) , calls : Some (pallet_grandpa :: Pallet :: < Runtime > :: call_functions ()) , event : Some (self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletEventMetadataIR { ty : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: scale_info :: meta_type :: < pallet_grandpa :: Event > () , }) , constants : pallet_grandpa :: Pallet :: < Runtime > :: pallet_constants_metadata () , error : pallet_grandpa :: Pallet :: < Runtime > :: error_metadata () , docs : pallet_grandpa :: Pallet :: < Runtime > :: pallet_documentation_metadata () , } , self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletMetadataIR { name : "Balances" , index : 4u8 , storage : Some (pallet_balances :: Pallet :: < Runtime > :: storage_metadata ()) , calls : Some (pallet_balances :: Pallet :: < Runtime > :: call_functions ()) , event : Some (self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletEventMetadataIR { ty : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: scale_info :: meta_type :: < pallet_balances :: Event < Runtime > > () , }) , constants : pallet_balances :: Pallet :: < Runtime > :: pallet_constants_metadata () , error : pallet_balances :: Pallet :: < Runtime > :: error_metadata () , docs : pallet_balances :: Pallet :: < Runtime > :: pallet_documentation_metadata () , } , self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletMetadataIR { name : "TransactionPayment" , index : 5u8 , storage : Some (pallet_transaction_payment :: Pallet :: < Runtime > :: storage_metadata ()) , calls : None , event : Some (self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletEventMetadataIR { ty : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: scale_info :: meta_type :: < pallet_transaction_payment :: Event < Runtime > > () , }) , constants : pallet_transaction_payment :: Pallet :: < Runtime > :: pallet_constants_metadata () , error : pallet_transaction_payment :: Pallet :: < Runtime > :: error_metadata () , docs : pallet_transaction_payment :: Pallet :: < Runtime > :: pallet_documentation_metadata () , } , self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletMetadataIR { name : "Sudo" , index : 6u8 , storage : Some (pallet_sudo :: Pallet :: < Runtime > :: storage_metadata ()) , calls : Some (pallet_sudo :: Pallet :: < Runtime > :: call_functions ()) , event : Some (self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletEventMetadataIR { ty : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: scale_info :: meta_type :: < pallet_sudo :: Event < Runtime > > () , }) , constants : pallet_sudo :: Pallet :: < Runtime > :: pallet_constants_metadata () , error : pallet_sudo :: Pallet :: < Runtime > :: error_metadata () , docs : pallet_sudo :: Pallet :: < Runtime > :: pallet_documentation_metadata () , } , self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletMetadataIR { name : "TemplateModule" , index : 7u8 , storage : Some (pallet_template :: Pallet :: < Runtime > :: storage_metadata ()) , calls : Some (pallet_template :: Pallet :: < Runtime > :: call_functions ()) , event : Some (self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: PalletEventMetadataIR { ty : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: scale_info :: meta_type :: < pallet_template :: Event < Runtime > > () , }) , constants : pallet_template :: Pallet :: < Runtime > :: pallet_constants_metadata () , error : pallet_template :: Pallet :: < Runtime > :: error_metadata () , docs : pallet_template :: Pallet :: < Runtime > :: pallet_documentation_metadata () , }])) , extrinsic : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: ExtrinsicMetadataIR { ty : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: scale_info :: meta_type :: < UncheckedExtrinsic > () , version : < UncheckedExtrinsic as self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_runtime :: traits :: ExtrinsicMetadata > :: VERSION , signed_extensions : < < UncheckedExtrinsic as self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_runtime :: traits :: ExtrinsicMetadata > :: SignedExtensions as self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_runtime :: traits :: SignedExtension > :: metadata () . into_iter () . map (| meta | self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: metadata_ir :: SignedExtensionMetadataIR { identifier : meta . identifier , ty : meta . ty , additional_signed : meta . additional_signed , }) . collect () , } , ty : self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: scale_info :: meta_type :: < Runtime > () , apis : (& rt) . runtime_metadata () , }
...
impl self::sp_api_hidden_includes_construct_runtime::hidden_include::unsigned::ValidateUnsigned
	for Runtime
{
	type Call = RuntimeCall;	fn pre_dispatch (call : & Self :: Call) -> Result < () , self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: unsigned :: TransactionValidityError >{
		#[allow(unreachable_patterns)]
		match call {
	...
	{
		# [allow (unreachable_patterns)] match call { RuntimeCall :: Grandpa (inner_call) => Grandpa :: validate_unsigned (source , inner_call) , _ => self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: unsigned :: UnknownTransaction :: NoUnsignedValidator . into () , }
	}
}
...
const _: () = {
	impl ::scale_info::TypeInfo for RuntimeFreezeReason {
		...
		fn type_info() -> ::scale_info::Type {
			::scale_info::Type::builder()
				.path(::scale_info::Path::new("RuntimeFreezeReason", "node_template_runtime"))
				.type_params(::alloc::vec::Vec::new())
...
const _: () = {
	impl ::scale_info::TypeInfo for RuntimeHoldReason {
		...
		fn type_info() -> ::scale_info::Type {
			::scale_info::Type::builder()
				.path(::scale_info::Path::new("RuntimeHoldReason", "node_template_runtime"))
				.type_params(::alloc::vec::Vec::new())
...
impl ::core::cmp::PartialOrd for RuntimeLockId {
	#[inline]
	fn partial_cmp(&self, other: &RuntimeLockId) -> ::core::option::Option<::core::cmp::Ordering> {
		unsafe { ::core::intrinsics::unreachable() }
	}
}
#[allow(deprecated)]
...
const _: () = {
	impl ::scale_info::TypeInfo for RuntimeSlashReason {
		...
		fn type_info() -> ::scale_info::Type {
			::scale_info::Type::builder()
				.path(::scale_info::Path::new("RuntimeSlashReason", "node_template_runtime"))
				.type_params(::alloc::vec::Vec::new())
...
const _: () =
	...
	{
		{
			:: core :: panicking :: panic_fmt (format_args ! ("The maximum encoded size of the error type in the `Sudo` pallet exceeds `MAX_MODULE_ERROR_ENCODED_SIZE`")) ;
		}
	};
const _: () =
    ...
    {
        {
            :: core :: panicking :: panic_fmt (format_args ! ("The maximum encoded size of the error type in the `TemplateModule` pallet exceeds `MAX_MODULE_ERROR_ENCODED_SIZE`")) ;
        }
    };
...
/// UncheckedExtrinsic 在runtime 里确定类型
...
pub struct RuntimeApiImpl<Block: sp_api::BlockT, C: sp_api::CallApiAt<Block> + 'static> {
	...
	storage_transaction_cache:
		std::cell::RefCell<sp_api::StorageTransactionCache<Block, C::StateBackend>>,
	...
	for RuntimeApiImpl<Block, C>
{
		...
		Self: Sized,
	{
		sp_api::CallApiAt::<Block>::runtime_version_at(self.call, at)
			.map(|v| sp_api::RuntimeVersion::has_api_with(&v, &A::ID, |v| v == A::VERSION))
	}
	...
	where
		Self: Sized,
	{
		let state_version = sp_api::CallApiAt::<Block>::runtime_version_at(
			self.call,
			std::clone::Clone::clone(&parent_hash),
		)
		.map(|v| sp_api::RuntimeVersion::state_version(&v))
		.map_err(|e| {
			let res = ::alloc::fmt::format(format_args!("Failed to get state version: {0}", e));
			res
		})?;
...
impl<Block: sp_api::BlockT, C: sp_api::CallApiAt<Block>> RuntimeApiImpl<Block, C> {
	...
	fn start_transaction(&self) {
		...
		sp_api::OverlayedChanges::start_transaction(&mut std::cell::RefCell::borrow_mut(
			&self.changes,
		));
...
impl sp_transaction_pool :: runtime_api :: runtime_decl_for_tagged_transaction_queue :: TaggedTransactionQueue < Block > for Runtime { fn validate_transaction (source : TransactionSource , tx : < Block as BlockT > :: Extrinsic , block_hash : < Block as BlockT > :: Hash) -> TransactionValidity { Executive :: validate_transaction (source , tx , block_hash) } }
impl sp_offchain::runtime_decl_for_offchain_worker_api::OffchainWorkerApi<Block> for Runtime {
...
impl
	frame_system_rpc_runtime_api::runtime_decl_for_account_nonce_api::AccountNonceApi<
		Block,
		AccountId,
		Index,
	> for Runtime
...
where
	...
	<__SrApiBlock__ as BlockT>::Header: std::panic::UnwindSafe + std::panic::RefUnwindSafe,
	__SrApiBlock__::Header: std::panic::UnwindSafe + std::panic::RefUnwindSafe,
{
	...
	// 例如 apply_extrinsic_with_context方法如下
	//
	...
	//   sp_api :: Encode :: encode (& (& *extrinsic*));
	//
	...
	//       | *err* | sp_api :: ApiError :: *FailedToDecodeReturnValue* {function : "BlockBuilder_apply_extrinsic" , error : *err*  },
	//       ))
	// }
	// 它会调用__runtime_api_internal_call_api_at 去调用 BlockBuilder_apply_extrinsic方法
	// 下面我们看一下它是怎么一步一步调用到apply_extrinsic中去的
	fn __runtime_api_internal_call_api_at(
		...
		// __runtime_api_internal_call_api_at 拿到 BlockBuilder_apply_extrinsic 之后
		// 会调用CallApiAt trait的call_api_at方法,该trait被client/service/client.rs实现了
		self.start_transaction();
		let res = (|| {
			let version = sp_api::CallApiAt::<__SrApiBlock__>::runtime_version_at(self.call, at)?;
			let params = sp_api::CallApiAtParams {
				at,
				function: (*fn_name)(version), // "BlockBuilder_apply_extrinsic version"
				arguments: params,
			...
			// CallApiAt 被client实现了
			// client/service/client.rs 实现了call_api_at方法
			// call_api_at调用了client/api里的call_executor.rs里的contextual_call方法
			// 最终调用了sp::Core 中的CodeExecutor trait的 call方法在contextual_call里
			// NativeElseWasmExecutor 实现了该方法call
			// 在这个call 方法里调用了NativeExecutionDispatchde trait 的 dispatcher方法
			// 在node-template中, 实现了该trait(这个trait需要用户实现) 实现如下:
			//
			...
			// }
			//
			// 其实这个实现就是调用一下runtime api 的dispatch(是在native的方式下的执行逻辑)
			// 最终调用的是runtime api提供的dispatch 也就是我们这里暴露出去的dispatch方法在文件的最下方
			// 它支持了一系列放法,其中一项就有我们需要的方法 BlockBuilder_apply_extrinsic
			// 代码如下:
			//
			// 			"BlockBuilder_apply_extrinsic" => Some(sp_api::Encode::encode(&{
			...
			// 						},
			// 					};
			// 				# [allow (deprecated)] < Runtime as sp_block_builder :: runtime_decl_for_block_builder :: BlockBuilder < Block > > :: apply_extrinsic (extrinsic)
			// 			})),
			//
			// 我们可以看到 在这里最终调用了Runtime的apply_extrinsic方法

			// 调用 "Core_execute_block"
...
where
	RuntimeApiImplCall::StateBackend: sp_api::StateBackend<sp_api::HashFor<__SrApiBlock__>>,
	&'static RuntimeApiImplCall: Send,
	<__SrApiBlock__ as BlockT>::Extrinsic: std::panic::UnwindSafe + std::panic::RefUnwindSafe,
	...
	Vec<<__SrApiBlock__ as BlockT>::Extrinsic>: std::panic::UnwindSafe + std::panic::RefUnwindSafe,
	__SrApiBlock__: std::panic::UnwindSafe + std::panic::RefUnwindSafe,
	sp_inherents::InherentData: std::panic::UnwindSafe + std::panic::RefUnwindSafe,
	...
	__SrApiBlock__::Header: std::panic::UnwindSafe + std::panic::RefUnwindSafe,
{
	...
	fn __runtime_api_internal_call_api_at(
		...
		context: sp_api::ExecutionContext,
		params: std::vec::Vec<u8>,
		fn_name: &dyn Fn(sp_api::RuntimeVersion) -> &'static str, 		// & | *_version* | {"BlockBuilder_apply_extrinsic" },
	) -> std::result::Result<std::vec::Vec<u8>, sp_api::ApiError> {
		// __runtime_api_internal_call_api_at 拿到 BlockBuilder_apply_extrinsic 之后
		// 会调用CallApiAt trait的call_api_at方法,该trait被client/service/client.rs实现了
		self.start_transaction();
		let res = (|| {
			...
			// 我们可以看到 在这里最终调用了Runtime的apply_extrinsic方法
			//
			// 而在apply_extrinsic方法里 会调用ApplayAble trait 的apply方法
			// CheckedExtrinsic 实现了该方法
			// RuntimeCall 实现了该方法
			// dispatch会找到目标pallet的目标方法并执行
			sp_api::CallApiAt::<__SrApiBlock__>::call_api_at(self.call, params)
		})();
		self.commit_or_rollback(std::result::Result::is_ok(&res));
		res
...
impl<
		__SrApiBlock__: sp_api::BlockT + std::panic::UnwindSafe + std::panic::RefUnwindSafe,
		RuntimeApiImplCall: sp_api::CallApiAt<__SrApiBlock__> + 'static,
	> sp_session::SessionKeys<__SrApiBlock__> for RuntimeApiImpl<__SrApiBlock__, RuntimeApiImplCall>
where
	RuntimeApiImplCall::StateBackend: sp_api::StateBackend<sp_api::HashFor<__SrApiBlock__>>,
	&'static RuntimeApiImplCall: Send,
...
where
	RuntimeApiImplCall::StateBackend: sp_api::StateBackend<sp_api::HashFor<__SrApiBlock__>>,
	&'static RuntimeApiImplCall: Send,
	sp_consensus_grandpa::AuthorityList: std::panic::UnwindSafe + std::panic::RefUnwindSafe,
...
impl<
		__SrApiBlock__: sp_api::BlockT + std::panic::UnwindSafe + std::panic::RefUnwindSafe,
		RuntimeApiImplCall: sp_api::CallApiAt<__SrApiBlock__> + 'static,
	> pallet_transaction_payment_rpc_runtime_api::TransactionPaymentApi<__SrApiBlock__, Balance>
	for RuntimeApiImpl<__SrApiBlock__, RuntimeApiImplCall>
where
	RuntimeApiImplCall::StateBackend: sp_api::StateBackend<sp_api::HashFor<__SrApiBlock__>>,
	&'static RuntimeApiImplCall: Send,
...
const RUNTIME_API_VERSIONS : sp_api :: ApisVec = :: sp_version :: sp_std :: borrow :: Cow :: Borrowed (& [(sp_api :: runtime_decl_for_core :: ID , sp_api :: runtime_decl_for_core :: VERSION) , (sp_api :: runtime_decl_for_metadata :: ID , sp_api :: runtime_decl_for_metadata :: VERSION) , (sp_block_builder :: runtime_decl_for_block_builder :: ID , sp_block_builder :: runtime_decl_for_block_builder :: VERSION) , (sp_transaction_pool :: runtime_api :: runtime_decl_for_tagged_transaction_queue :: ID , sp_transaction_pool :: runtime_api :: runtime_decl_for_tagged_transaction_queue :: VERSION) , (sp_offchain :: runtime_decl_for_offchain_worker_api :: ID , sp_offchain :: runtime_decl_for_offchain_worker_api :: VERSION) , (sp_consensus_aura :: runtime_decl_for_aura_api :: ID , sp_consensus_aura :: runtime_decl_for_aura_api :: VERSION) , (sp_session :: runtime_decl_for_session_keys :: ID , sp_session :: runtime_decl_for_session_keys :: VERSION) , (sp_consensus_grandpa :: runtime_decl_for_grandpa_api :: ID , sp_consensus_grandpa :: runtime_decl_for_grandpa_api :: VERSION) , (frame_system_rpc_runtime_api :: runtime_decl_for_account_nonce_api :: ID , frame_system_rpc_runtime_api :: runtime_decl_for_account_nonce_api :: VERSION) , (pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_api :: ID , pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_api :: VERSION) , (pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_call_api :: ID , pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_call_api :: VERSION)]) ;
const _: () = {};
const _: () = {};
const _: () = {};
const _: () = {};
...
trait InternalImplRuntimeApis {
	#[inline(always)]
	fn runtime_metadata(&self) -> sp_api::vec::Vec<sp_api::metadata_ir::RuntimeApiMetadataIR> {
		< [_] > :: into_vec (# [rustc_box] :: alloc :: boxed :: Box :: new ([sp_api :: runtime_decl_for_core :: runtime_metadata :: < Block > () , sp_api :: runtime_decl_for_metadata :: runtime_metadata :: < Block > () , sp_block_builder :: runtime_decl_for_block_builder :: runtime_metadata :: < Block > () , sp_transaction_pool :: runtime_api :: runtime_decl_for_tagged_transaction_queue :: runtime_metadata :: < Block > () , sp_offchain :: runtime_decl_for_offchain_worker_api :: runtime_metadata :: < Block > () , sp_consensus_aura :: runtime_decl_for_aura_api :: runtime_metadata :: < Block , AuraId > () , sp_session :: runtime_decl_for_session_keys :: runtime_metadata :: < Block > () , sp_consensus_grandpa :: runtime_decl_for_grandpa_api :: runtime_metadata :: < Block > () , frame_system_rpc_runtime_api :: runtime_decl_for_account_nonce_api :: runtime_metadata :: < Block , AccountId , Index > () , pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_api :: runtime_metadata :: < Block , Balance > () , pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_call_api :: runtime_metadata :: < Block , Balance , RuntimeCall > ()]))
	}
}
#[doc(hidden)]
...
pub mod api {
	...
	pub fn dispatch(method: &str, mut _sp_api_input_data_: &[u8]) -> Option<Vec<u8>> {
		match method {
			"Core_version" => Some(sp_api::Encode::encode(&{
				if !_sp_api_input_data_.is_empty() {
					{
						:: core :: panicking :: panic_fmt (format_args ! ("Bad input data provided to {0}: expected no parameters, but input buffer is not empty." , "version")) ;
					};
				}
				#[allow(deprecated)]
				<Runtime as sp_api::runtime_decl_for_core::Core<Block>>::version()
			})),
			"Core_execute_block" => Some(sp_api::Encode::encode(&{
			...
			"Core_initialize_block" => Some(sp_api::Encode::encode(&{
				...
				#[allow(deprecated)]
				<Runtime as sp_api::runtime_decl_for_core::Core<Block>>::initialize_block(&header)
			})),
			"Metadata_metadata" => Some(sp_api::Encode::encode(&{
				if !_sp_api_input_data_.is_empty() {
					{
						:: core :: panicking :: panic_fmt (format_args ! ("Bad input data provided to {0}: expected no parameters, but input buffer is not empty." , "metadata")) ;
					};
				}
				#[allow(deprecated)]
			...
			"Metadata_metadata_at_version" =>
				Some(sp_api::Encode::encode(&{
					...
					# [allow (deprecated)] < Runtime as sp_api :: runtime_decl_for_metadata :: Metadata < Block > > :: metadata_at_version (version)
				})),
			"Metadata_metadata_versions" => Some(sp_api::Encode::encode(&{
				if !_sp_api_input_data_.is_empty() {
					{
						:: core :: panicking :: panic_fmt (format_args ! ("Bad input data provided to {0}: expected no parameters, but input buffer is not empty." , "metadata_versions")) ;
					};
				}
				#[allow(deprecated)]
				<Runtime as sp_api::runtime_decl_for_metadata::Metadata<Block>>::metadata_versions()
			})),
			"BlockBuilder_apply_extrinsic" => Some(sp_api::Encode::encode(&{
				...
				///
				/// 而 runtime/generic/block.rs block实现了该Block Trait
				...
				/// }
				///
				/// 在Runtime里导入了这个Block而不是原始的Block trait
				///
				/// 导入的时候别名BlockT     Block as BlockT
				///
				///	不过这个Block需要在使用的地方指定 Header和Extrinsic
				/// 在Runtime里进行指定了
				/// /// Block type as expected by this runtime.
				/// pub type Block = generic::Block<Header, UncheckedExtrinsic>;
				///
				/// 而这里的UncheckedExtrinsic也需要在这里确定类型,如下
				/// /// Unchecked extrinsic type as expected by this runtime.
				/// /// UncheckedExtrinsic 在runtime 里确定类型
				/// pub type UncheckedExtrinsic =
				/// 	generic::UncheckedExtrinsic<Address, RuntimeCall, Signature, SignedExtra>;
				///
				/// 所以这里得到的extrinsic是 UncheckedExtrinsic<Address, RuntimeCall, Signature, SignedExtra>类型的
				/// 这个类型非常重要
				/// 这个extrinsic会在apply_extrinsic的时候
				/// 先进行 extrinsic.check() extrinsic实现了Checkable, 并且指定了关联类型为 CheckedExtrinsic<AccountId, Call, Extra>
				/// check之后返回了CheckedExtrinsic<AccountId, Call, Extra>类型, 这里的三个类型对应UncheckedExtrinsic中在Runtime里指定的RuntimeCall, Signature, SignedExtra
				///
				///	返回之后会调用 CheckedExtrinsic的apply方法,
				/// CheckedExtrinsic实现了ApplyAble trait 该trait有apply方法
				///    这里的三种类型对应上面这三种 <RuntimeCall, Signature, SignedExtra>
				...
				/// }
				///
				/// 其中function字段就是我们这里的RuntimeCall
				///
				/// 在apply方法中调用了 function::dispatch即RuntimeCall的dispatch方法
				/// 先调用     xt.get_dispatch_info()
				/// get_dispatch_info实现是 function.get_dispatch_info 即 RuntimeCall.get_dispatch_info
				/// 然后调用 apply
			...
			"BlockBuilder_finalize_block" => Some(sp_api::Encode::encode(&{
				if !_sp_api_input_data_.is_empty() {
					{
						:: core :: panicking :: panic_fmt (format_args ! ("Bad input data provided to {0}: expected no parameters, but input buffer is not empty." , "finalize_block")) ;
					};
				}
				# [allow (deprecated)] < Runtime as sp_block_builder :: runtime_decl_for_block_builder :: BlockBuilder < Block > > :: finalize_block ()
			})),
			"BlockBuilder_inherent_extrinsics" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as sp_block_builder :: runtime_decl_for_block_builder :: BlockBuilder < Block > > :: inherent_extrinsics (data)
			})),
			"BlockBuilder_check_inherents" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as sp_block_builder :: runtime_decl_for_block_builder :: BlockBuilder < Block > > :: check_inherents (block , data)
			})),
			"TaggedTransactionQueue_validate_transaction" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as sp_transaction_pool :: runtime_api :: runtime_decl_for_tagged_transaction_queue :: TaggedTransactionQueue < Block > > :: validate_transaction (source , tx , block_hash)
			})),
			"OffchainWorkerApi_offchain_worker" =>
				Some(sp_api::Encode::encode(&{
					...
					# [allow (deprecated)] < Runtime as sp_offchain :: runtime_decl_for_offchain_worker_api :: OffchainWorkerApi < Block > > :: offchain_worker (& header)
				})),
			"AuraApi_slot_duration" => Some(sp_api::Encode::encode(&{
				if !_sp_api_input_data_.is_empty() {
					{
						:: core :: panicking :: panic_fmt (format_args ! ("Bad input data provided to {0}: expected no parameters, but input buffer is not empty." , "slot_duration")) ;
					};
				}
				# [allow (deprecated)] < Runtime as sp_consensus_aura :: runtime_decl_for_aura_api :: AuraApi < Block , AuraId > > :: slot_duration ()
			})),
			"AuraApi_authorities" => Some(sp_api::Encode::encode(&{
				if !_sp_api_input_data_.is_empty() {
					{
						:: core :: panicking :: panic_fmt (format_args ! ("Bad input data provided to {0}: expected no parameters, but input buffer is not empty." , "authorities")) ;
					};
				}
				# [allow (deprecated)] < Runtime as sp_consensus_aura :: runtime_decl_for_aura_api :: AuraApi < Block , AuraId > > :: authorities ()
			})),
			"SessionKeys_generate_session_keys" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as sp_session :: runtime_decl_for_session_keys :: SessionKeys < Block > > :: generate_session_keys (seed)
			})),
			"SessionKeys_decode_session_keys" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as sp_session :: runtime_decl_for_session_keys :: SessionKeys < Block > > :: decode_session_keys (encoded)
			})),
			"GrandpaApi_grandpa_authorities" => Some(sp_api::Encode::encode(&{
				if !_sp_api_input_data_.is_empty() {
					{
						:: core :: panicking :: panic_fmt (format_args ! ("Bad input data provided to {0}: expected no parameters, but input buffer is not empty." , "grandpa_authorities")) ;
					};
				}
				# [allow (deprecated)] < Runtime as sp_consensus_grandpa :: runtime_decl_for_grandpa_api :: GrandpaApi < Block > > :: grandpa_authorities ()
			})),
			"GrandpaApi_current_set_id" => Some(sp_api::Encode::encode(&{
				if !_sp_api_input_data_.is_empty() {
					{
						:: core :: panicking :: panic_fmt (format_args ! ("Bad input data provided to {0}: expected no parameters, but input buffer is not empty." , "current_set_id")) ;
					};
				}
				# [allow (deprecated)] < Runtime as sp_consensus_grandpa :: runtime_decl_for_grandpa_api :: GrandpaApi < Block > > :: current_set_id ()
			})),
			"GrandpaApi_submit_report_equivocation_unsigned_extrinsic" =>
				Some(sp_api::Encode::encode(&{
					...
					>>::submit_report_equivocation_unsigned_extrinsic(
						_equivocation_proof, _key_owner_proof
					)
				})),
			"GrandpaApi_generate_key_ownership_proof" => Some(sp_api::Encode::encode(&{
				let (_set_id, _authority_id): (sp_consensus_grandpa::SetId, GrandpaId) =
					match sp_api::DecodeLimit::decode_all_with_depth_limit(
						sp_api::MAX_EXTRINSIC_DEPTH,
						&mut _sp_api_input_data_,
					) {
				...
				# [allow (deprecated)] < Runtime as sp_consensus_grandpa :: runtime_decl_for_grandpa_api :: GrandpaApi < Block > > :: generate_key_ownership_proof (_set_id , _authority_id)
			})),
			"AccountNonceApi_account_nonce" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as frame_system_rpc_runtime_api :: runtime_decl_for_account_nonce_api :: AccountNonceApi < Block , AccountId , Index > > :: account_nonce (account)
			})),
			"TransactionPaymentApi_query_info" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_api :: TransactionPaymentApi < Block , Balance > > :: query_info (uxt , len)
			})),
			"TransactionPaymentApi_query_fee_details" => Some(sp_api::Encode::encode(&{
				let (uxt, len): (<Block as BlockT>::Extrinsic, u32) =
					match sp_api::DecodeLimit::decode_all_with_depth_limit(
						sp_api::MAX_EXTRINSIC_DEPTH,
						&mut _sp_api_input_data_,
				...
				# [allow (deprecated)] < Runtime as pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_api :: TransactionPaymentApi < Block , Balance > > :: query_fee_details (uxt , len)
			})),
			"TransactionPaymentApi_query_weight_to_fee" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_api :: TransactionPaymentApi < Block , Balance > > :: query_weight_to_fee (weight)
			})),
			"TransactionPaymentApi_query_length_to_fee" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_api :: TransactionPaymentApi < Block , Balance > > :: query_length_to_fee (length)
			})),
			"TransactionPaymentCallApi_query_call_info" => Some(sp_api::Encode::encode(&{
				...
				# [allow (deprecated)] < Runtime as pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_call_api :: TransactionPaymentCallApi < Block , Balance , RuntimeCall > > :: query_call_info (call , len)
			})),
			"TransactionPaymentCallApi_query_call_fee_details" => Some(sp_api::Encode::encode(&{
				let (call, len): (RuntimeCall, u32) =
					match sp_api::DecodeLimit::decode_all_with_depth_limit(
						sp_api::MAX_EXTRINSIC_DEPTH,
						&mut _sp_api_input_data_,
				...
				# [allow (deprecated)] < Runtime as pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_call_api :: TransactionPaymentCallApi < Block , Balance , RuntimeCall > > :: query_call_fee_details (call , len)
			})),
			"TransactionPaymentCallApi_query_weight_to_fee" => Some(sp_api::Encode::encode(&{
				let weight: Weight = match sp_api::DecodeLimit::decode_all_with_depth_limit(
					sp_api::MAX_EXTRINSIC_DEPTH,
					&mut _sp_api_input_data_,
				) {
				...
				# [allow (deprecated)] < Runtime as pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_call_api :: TransactionPaymentCallApi < Block , Balance , RuntimeCall > > :: query_weight_to_fee (weight)
			})),
			"TransactionPaymentCallApi_query_length_to_fee" => Some(sp_api::Encode::encode(&{
				let length: u32 = match sp_api::DecodeLimit::decode_all_with_depth_limit(
					sp_api::MAX_EXTRINSIC_DEPTH,
					&mut _sp_api_input_data_,
				) {
				...
				# [allow (deprecated)] < Runtime as pallet_transaction_payment_rpc_runtime_api :: runtime_decl_for_transaction_payment_call_api :: TransactionPaymentCallApi < Block , Balance , RuntimeCall > > :: query_length_to_fee (length)
			})),
			_ => None,
		}
	}
